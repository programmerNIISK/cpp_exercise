...
* Кнопка « *Сбросить положение манипуляторов* »
...
После выполнения чтения файла у манипуляторов будут новые координаты, которые были установлены чтения всех точек и перемещений. Соответственно при дополнительных нажатиях на кнопку « *начать чтение файла* », повторяются те же действия, но с новыми начальными координатами. 

Кнопка « *Сбросить положение манипуляторов* » должна сбрасывать положение манипуляторов на начальное.
...
Кнопка « *Сбросить положение манипуляторов* » должна сбрасывать положение манипуляторов на начальное и при этом стирать прошлый маршрут манипуляторов.
